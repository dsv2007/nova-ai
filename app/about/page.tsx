  ...
  const values = [
    {
      ...
      title: "Our Mission",
      desc: "Secure enterprise data integrity, system availability, and block corruption events across cloud directories and distributed filesystems."
    },
    {
      icon: <Eye className="w-8 h-8 text-orange-400" />,
      title: "Our Vision",
      desc: "A system environment shielded from silent data corruption through continuous checksum indexers and automated self-healing recoveries."
    },
    {
      icon: <Shield className="w-8 h-8 text-amber-400" />,
      title: "Our Values",
      desc: "Integrity, security, and visibility. We build trust through cryptographically verifiable SHA hashes, immutable syslog streams, and high sensor SLA."
    }
  ];

  const stats = [
    { value: "2022", label: "Founded" },
    { value: "5k+", label: "Sensors Active" },
    { value: "24+", label: "Core Contributors" },
    { value: "1.2B+", label: "Scanned Files" },
    { value: "99.99%", label: "Sensor Uptime SLA" },
    { value: "4.9★", label: "Sysadmin Rating" }
  ];

  const team = [
    { name: "Alex Chen", role: "CEO & Co-founder", avatar: "👨‍💼", desc: "Ex-PagerDuty Product Lead. Dedicated to making complex incident response automated." },
    { name: "Sarah Kim", role: "CTO & Co-founder", avatar: "👩‍💻", desc: "Distributed filesystem architect. Formerly infrastructure engineer at Datadog." },
    { name: "Marcus Rivera", role: "Head of Research", avatar: "🧠", desc: "PhD in Cryptographic Validation. Formerly security systems designer at Splunk." },
    { name: "Priya Patel", role: "Head of UX Design", avatar: "🎨", desc: "SysOps interface developer. Crafting clean, high-performance command dashboards." }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-slate-400 text-base md:text-lg leading-relaxed">
            Founded in 2022, Nova AI was built with one goal — make enterprise-grade filesystem monitoring, check-sum analysis, and automated rollback scripts accessible to every DevOps and SysOps team.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          {values.map((val, idx) => (
            ...
            >
              <div>
                <div className="w-14 h-14 rounded-xl bg-slate-950 flex items-center justify-center border border-slate-800 mb-6 group-hover:shadow-lg group-hover:shadow-red-500/5 transition-all">
                  {val.icon}
                </div>
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4">Meet the Builders</h2>
          <p className="text-slate-400 text-sm md:text-base max-w-lg mx-auto">
            A collaborative group of systems developers, cryptographic researchers, and interface designers dedicated to system availability.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {team.map((member, idx) => (
            ...
            >
              ...
              <p className="text-red-400 text-xs font-semibold mb-3">{member.role}</p>
